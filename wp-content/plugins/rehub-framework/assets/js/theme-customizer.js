...
( function( $ ) {
	...
	if($('.rh-comparemenu-link.rh-header-icon').length > 0){
		$('.rh-comparemenu-link.rh-header-icon').prepend("<span class='re-compare-icon-toggle position-relative'><i class='rhicon rhi-shuffle' aria-hidden='true'></i><span class='re-compare-notice rehub-main-color-bg'>0</span></span>")
	}	
